...
<script lang="ts">
  ...
  import { pageReveal, staggerReveal } from '../../lib/motionActions';
...
<div class="flex flex-col border-r border-border overflow-hidden min-w-0 glass-card" use:pageReveal={{ delay: 0.08 }}>
  ...
  <div class="flex-1 overflow-y-auto px-2 flex flex-col gap-[1px] stagger-children" use:staggerReveal>
    {#if tasks.length === 0}
      <EmptyState
        icon="◻"
