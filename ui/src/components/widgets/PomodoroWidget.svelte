...
<script lang="ts">
  ...
  import { hoverLift, pageReveal } from '../../lib/motionActions';
...
<div class="bg-surface rounded-2xl shadow-card border border-border p-4 glass-card" use:pageReveal={{ delay: 0.04 }} use:hoverLift>
